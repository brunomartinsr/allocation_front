            ...
            <div key={i} className="pedido-card">
              <div className="pedido-header">
                ...
                <div style={{ textAlign: 'right' }}>
                  ...
                  <div style={{ fontSize: 13, color: 'var(--app-text)', fontFamily: 'var(--mono)', marginTop: 2 }}>
              ...
              <div style={{ fontSize: 13, color: 'var(--app-text)', marginBottom: 12 }}>
                <strong style={{ color: 'var(--app-text-h)' }}>Origem:</strong> {pedido.origem}<br />
                <strong style={{ color: 'var(--app-text-h)' }}>Destino:</strong> {pedido.destino}
              </div>
